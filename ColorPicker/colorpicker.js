...
function you_win(color){
    for(var i=0; i<num_squares; i++){
        squares[i].getElementsByClassName.background = color;
    }
}
...
function restart_game(){
    ...
    challenge.innerHTML = "please select: <br/><br/> " +pick_color+ "<br/><br/>from the choices below";
    ...
    for (var i=0; i<squares.length; i++){
        squares[i].addEventListener("click",function(){
            ...
            if (this.style.background === pick_color){
                ...
                challenge.style.background = pick_color;
