...
function helper(){
    ...
    drawScore(user.score,22*can.width/100,can.height/6);
    drawScore(cpu.score,72*can.width/100,can.height/6);
    drawSeparator();
...
function updates(){
    ...
    if(detect_collision(ball,player)){
        ...
        // when the ball hits the top of the paddle we want the ball to take a -45 deg angle
        // when the ball hits the center of the paddle we want the ball to take a 0 deg angle
        // when the ball hits the bottom of the paddle we want the ball to a 45 deg angle
        ...
        //speed up ball everytime it is hit by a paddle
        ball.speed+=1;
    }
}
